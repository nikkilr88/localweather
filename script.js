  ...
  */
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function(location) {
      ...
      var api = 'https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&units=imperial&APPID=ec50a6072ac189dee111acdd3a38ab9f';

      var api2 = 'https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/forecast/daily?lat=' + lat + '&lon=' + lon + '&cnt=6&units=imperial&APPID=0f9dcff76057c29f88aed473e06d0138';
